...
const Login = () => {
    ...
    const router = useRouter()
    useEffect(() => {
        document.title = "Login - TeaBreeze"
        if (session) {
        router.push('/dashboard')
        }
    }, [router, session])
  ...
  return (
    <div className='py-10 container mx-auto px-5 md:px-0'>
        ...
        <div className="flex flex-col gap-2 items-center min-h-screen p-10">
                ...
                <button
                    className="flex items-center w-64 text-black bg-slate-50 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm 
                    font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <button onClick={()=>{signIn("github")}}
                    className="flex items-center w-64 text-black bg-slate-50 border border-gray-300 rounded-lg 
                    shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 
